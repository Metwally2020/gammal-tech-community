...
class ProblemSolving extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      key: scaffoldKey,
      appBar: AppBar(
        title: Text('Gammal Tech Community'),
      ),
      body: problemSolving(
...
Widget problemSolving(
    {scaffoldKey, context, lessonName, type, lang, author, user}) {
  // var scaffoldKey = GlobalKey<ScaffoldState>();
                  ...
                  child: RefreshIndicator(
                    onRefresh: () {
                      return Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ProblemSolving(
                                    lessonName: lessonName,
                                    type: type,
                                    author: author,
                                  )));
