...
Widget arabicHome(GlobalKey<ScaffoldState> scaffoldKey, context) {
  var arabicPostDescription;
  var youtube;
  var facebook;
  var linkedin;
  var vimeo;
  ...
  var arbicPostController = TextEditingController();
  ...
  Future<void> _refresh() {
    return Navigator.push(
        context, MaterialPageRoute(builder: (context) => PostLang(lang: 1)));
  }

  return FutureBuilder<List<Post>>(
    future: FirestoreService().getPosts('ar'),
                  ...
                  children: [
                                          ...
                                          children: [
                                            ...
                                            Directionality(
                                              ...
                                              child: defaultFormField(
                                                controller: arbicPostController,
                                                label: 'وصف المنشور',
                    ...
                    SizedBox(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) => ArabicPost(
                          context,
                          post: posts[index],
                        ),
